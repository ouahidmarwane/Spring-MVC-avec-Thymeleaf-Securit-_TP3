package ma.mundia.Thymeleaf.marwane.ouahid.web; // Je place ici mes contrôleurs web
...
import ma.mundia.Thymeleaf.marwane.ouahid.entities.Product; // Mon entité Product
import ma.mundia.Thymeleaf.marwane.ouahid.repository.ProductRepository; // J'accède à la base via ce repository
