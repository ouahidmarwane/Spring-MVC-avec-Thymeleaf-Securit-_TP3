package ma.mundia.Thymeleaf.marwane.ouahid.repository; // Dossier où se trouve le repository

import ma.mundia.Thymeleaf.marwane.ouahid.entities.Product; // J'utilise l'entité Product
