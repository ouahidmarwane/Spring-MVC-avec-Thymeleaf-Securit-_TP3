package ma.mundia.Thymeleaf.marwane.ouahid; // Je mets ma classe principale dans ce package

import ma.mundia.Thymeleaf.marwane.ouahid.entities.Product; // J'utilise mon entité Product
import ma.mundia.Thymeleaf.marwane.ouahid.repository.ProductRepository; // J'accède à la base via le repository
